 ...
 * to an I2C signal. This code is designed to work with a Raspberry Pi and the
 * Pi4J libraries.
 *
 */
public class TSL2561 {

    public enum ADDR_PIN_STATE {
        GND, FLOATING, HIGH_3V3
    }
     ...
     *
     * @param p The status of the "ADR" pin on the device. This determines a
     * unique address for the device. Two devices on the same I2C network cannot
     * share an address. The addresses are:
     *
     * GND: 0x29 Floating: 0x39 3V3: 0x49
     */
    public TSL2561(ADDR_PIN_STATE p) throws IOException {
        
        this.lastInfraredReading = 0;
        this.lastVisibleReading = 0;
